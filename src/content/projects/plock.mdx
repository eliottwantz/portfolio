...
<div class="flex justify-center mb-10">
  <Carousel
    client:load
    images={[
      { src: '/plock/demo.gif', alt: 'Demo of Plock' },
      { src: '/plock/demo-iphone.gif', alt: 'Using Plock with Expo for mobile app authentication' },
      { src: '/plock/readme.png', alt: 'Plock README' }
    ]}
  />
</div>
...
## Links
- [Github](https://github.com/eliottwantz/plock)