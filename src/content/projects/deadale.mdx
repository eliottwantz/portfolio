...
isFeatured: true
tags: ['Next.js', 'TypeScript', 'Tailwindcss', 'Postgres', 'Stripe', 'Go', 'OpenAI', 'ElevenLabs']
seo:
  image:
    src: '/deadale/1.png'
    alt: Project preview
